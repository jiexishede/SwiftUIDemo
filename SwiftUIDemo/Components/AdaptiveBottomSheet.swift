...
// Note: cornerRadius extension and RoundedCorner struct are defined in TextLayoutDemoView.swift
// 注意：cornerRadius 扩展和 RoundedCorner 结构体定义在 TextLayoutDemoView.swift 中
